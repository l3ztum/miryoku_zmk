...
U_NP,              &kp HYP,           U_LT(U_FUN, DELETE),  U_LT(U_SYM, TAB),  U_LT(U_NUM, BSPC), U_LT(U_NAV, SPACE),  U_LT(U_MOUSE, RET), U_LT(U_MEDIA, ESC), &kp MEH,           U_NP
...
U_NP,              &trans,            &kp DELETE,        &kp TAB,           &kp BSPC,          U_NA,              U_NA,              U_NA,             &trans,            U_NP
